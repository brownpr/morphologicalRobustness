...
def initialize_params(n_x, n_y, n_h, bounds):
...
def forward_propagation(X, parameters, af):
...
def update_params_gaussian(parameters, bounds, noise):
...
if __name__ == "__main__":
    pass
    # X = [8, 5, 9]
    # a = initialize_params(len(X), 1, 16, (-1.5, 1.5))
    # b = forward_propagation(X, a, "t")[0]
    # c = update_params_gaussian(a, (-1.5, 1.5), 0.005)
    # print("hello")